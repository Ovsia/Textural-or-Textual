...
def train( model,Origin,Nons,Cons,Typo):
    ...
    for epoch in range(num_epochs):
        ...
        for i,(data, data_cons,data_typo,data_nonsense) in enumerate(zip(ImageNet100Origin,ImageNet100Cons,ImageNet100Typo,ImageNet100Nons)):
            ...
            text2 = ["a photo of a word written over a picture of a " + catogery_origin[i] for i in range(len(catogery_origin))]
        ...
        torch.save(model.state_dict(), f'/d/mqy/test/model/med/bs512_lr1e4/ours_epoch_{epoch + 1}.pt')
